...
public class DBUtil {
	...
	public static void setUpInitialData(Vertx vertx) throws Exception {
		...
		/*
		.put("url", "jdbc:hsqldb:./accounts;MODE=MYSQL;readonly=true;hsqldb.lock_file=false;hsqldb.sqllog=3;shutdown=true;syntax_ora=true")
		 */
		LOGGER.info("Start setup initial database.");
	    final JDBCClient client = JDBCClient.createShared(vertx, new JsonObject()
	            .put("url", "jdbc:hsqldb:mem:test;hsqldb.lock_file=false;shutdown=true")
