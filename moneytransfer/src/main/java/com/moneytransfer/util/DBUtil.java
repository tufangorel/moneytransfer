	...
	public static void setUpInitialData(Vertx vertx) throws Exception {
	    ...
	    client.getConnection(conn -> {
	        ...
	        connection.setAutoCommit(false, res -> {
		        ...
		        connection.execute("drop table if exists user; CREATE TABLE user(id INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY, name varchar(255))", create -> {
		            if (create.failed()) {
